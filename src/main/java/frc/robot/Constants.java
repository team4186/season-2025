...
public final class Constants {
  ...
  public static final class DeAlgaeConstants {
    public static final double DE_ALGAE_DEFAULT_ANGLE = 1.114; //TODO: find arm offset
    public static final double DE_ALGAE_FLAT_ANGLE = 90; //TODO: find the 'distance' of 90 degrees
    public static final double DE_ALGAE_MAX_SPEED = 0.1; // TODO: placeholder
    public static final double DE_ALGAE_MIN_SPEED = 0.05; //TODO: placeHolder
    public static final double DE_ALGAE_P = 1; //TODO: tune pid values
    public static final double DE_ALGAE_I = 0.0;
    public static final double DE_ALGAE_D = 0.0;
    public static final double DE_ALGAE_MAX_ANGLE = 110.0; // TODO: find max arc
    public static final double DE_ALGAE_MIN_ANGLE = 35.0; // TODO: find min arc

    public static final double DE_ALGAE_WHEEL_MAX_SPEED = 0.2; // TODO: placeholder
    public static final double DE_ALGAE_WHEEL_MIN_SPEED = 0.1; //TODO: placeHolder
  }
